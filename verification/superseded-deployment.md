...
> Historical evidence only. Contract `0x67099434f4e200862238DfdF9065BE8B827F26ef` predates the canonical-chain integrity remediation and must not be used as the current matching deployment.
